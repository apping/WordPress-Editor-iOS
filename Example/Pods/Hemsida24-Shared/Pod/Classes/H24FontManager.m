...
#import "H24FontManager.h"

#import "H24Logging.h"

#import <CoreText/CoreText.h>

@implementation H24FontManager

static NSString * const SharedBundle = @"Hemsida24-Shared.bundle";
...
+ (void)dynamicallyLoadFontResourceNamed:(NSString *)name withExtension:(NSString *)extension
{
    ...
    if (fontData) {
        ...
        if (!CTFontManagerRegisterGraphicsFont(font, &error)) {
            ...
            LogError(@"Failed to load font: %@", errorDescription);
