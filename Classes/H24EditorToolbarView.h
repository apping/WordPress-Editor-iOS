...
typedef enum
{
    kH24EditorViewControllerElementTagUnknown = -1,
    kH24EditorViewControllerElementTagJustifyLeftBarButton,
    kH24EditorViewControllerElementTagJustifyCenterBarButton,
    kH24EditorViewControllerElementTagJustifyRightBarButton,
    kH24EditorViewControllerElementTagJustifyFullBarButton,
    kH24EditorViewControllerElementTagBackgroundColorBarButton,
    kH24EditorViewControllerElementTagBlockQuoteBarButton,
    kH24EditorViewControllerElementTagBoldBarButton,
    kH24EditorViewControllerElementTagH1BarButton,
    kH24EditorViewControllerElementTagH2BarButton,
    kH24EditorViewControllerElementTagH3BarButton,
    kH24EditorViewControllerElementTagH4BarButton,
    kH24EditorViewControllerElementTagH5BarButton,
    kH24EditorViewControllerElementTagH6BarButton,
    kH24EditorViewControllerElementTagHorizontalRuleBarButton,
    kH24EditorViewControllerElementTagIndentBarButton,
    kH24EditorViewControllerElementTagInsertImageBarButton,
    kH24EditorViewControllerElementTagInsertLinkBarButton,
    kH24EditorViewControllerElementTagItalicBarButton,
    kH24EditorViewControllerElementOrderedListBarButton,
    kH24EditorViewControllerElementOutdentBarButton,
    kH24EditorViewControllerElementQuickLinkBarButton,
    kH24EditorViewControllerElementRedoBarButton,
    kH24EditorViewControllerElementRemoveFormatBarButton,
    kH24EditorViewControllerElementRemoveLinkBarButton,
    kH24EditorViewControllerElementShowSourceBarButton,
    kH24EditorViewControllerElementiPhoneShowSourceBarButton,
    kH24EditorViewControllerElementStrikeThroughBarButton,
    kH24EditorViewControllerElementSubscriptBarButton,
    kH24EditorViewControllerElementSuperscriptBarButton,
    kH24EditorViewControllerElementTextColorBarButton,
    kH24EditorViewControllerElementUnderlineBarButton,
    kH24EditorViewControllerElementUnorderedListBarButton,
    kH24EditorViewControllerElementUndoBarButton,
    
} H24EditorViewControllerElementTag;

@protocol H24EditorToolbarViewDelegate <NSObject>
@required
/**
 ...
 */
@interface H24EditorToolbarView : UIView
 ...
 */
@property (nonatomic, weak, readwrite) id<H24EditorToolbarViewDelegate> delegate;
