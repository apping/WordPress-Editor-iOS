...
static NSString* const kH24EditorFieldJavascriptFalse = @"false";
static NSString* const kH24EditorFieldJavascriptTrue = @"true";

@interface H24EditorField ()
...
- (void)setRightToLeftTextEnabled:(BOOL)isRTL
{
    ...
    if (isRTL) {
        rtlString = kH24EditorFieldJavascriptTrue;
    } else {
        rtlString = kH24EditorFieldJavascriptFalse;
    }
...
- (void)setMultiline:(BOOL)multiline
{
    ...
    if (multiline) {
        multilineString = kH24EditorFieldJavascriptTrue;
    } else {
        multilineString = kH24EditorFieldJavascriptFalse;
    }
