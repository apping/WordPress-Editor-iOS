#import "H24EditorViewController.h"
...
#import "H24ImageMeta.h"
#import "ZSSBarButtonItem.h"
#import "H24Logging.h"
#import <Hemsida24-Shared/H24FontManager.h>

CGFloat const EPVCStandardOffset = 10.0;
NSInteger const H24ImageAlertViewTag = 91;
NSInteger const H24LinkAlertViewTag = 92;

@interface H24EditorViewController () <HRColorPickerViewControllerDelegate, UIAlertViewDelegate, H24EditorToolbarViewDelegate, H24EditorViewDelegate>
...
@property (nonatomic, weak) H24EditorField* focusedField;
...
@property (nonatomic, strong, readwrite) H24EditorView *editorView;

#pragma mark - Properties: Toolbar
@property (nonatomic, strong, readwrite) H24EditorToolbarView* toolbarView;

@end

@implementation H24EditorViewController

#pragma mark - Initializers

- (instancetype)init
{
	return [self initWithMode:kH24EditorViewControllerModeEdit];
}
...
- (instancetype)initWithMode:(H24EditorViewControllerMode)mode
{
	...
	if (self) {
		...
		if (mode == kH24EditorViewControllerModePreview) {
			editing = NO;
		} else {
			editing = YES;
		}
...
{
	if (editing == kH24EditorViewControllerModePreview) {
		_editing = NO;
	} else {
		_editing = YES;
	}
...
- (void)createToolbarView
{
    ...
    CGRect toolbarFrame = CGRectMake(0,
                                     ...
                                     [H24EditorToolbarView height]);
    
    _toolbarView = [[H24EditorToolbarView alloc] initWithFrame:toolbarFrame];
    _toolbarView.delegate = self;
    _toolbarView.autoresizingMask = UIViewAutoresizingFlexibleWidth;
    _toolbarView.borderColor = [UIColor grayColor];
    _toolbarView.itemTintColor = [UIColor darkGrayColor];
    _toolbarView.selectedItemTintColor = [UIColor blackColor];
...
- (void)viewDidLoad
{
    ...
    [H24FontManager openSansRegularFontOfSize:16.0];
    [H24FontManager openSansItalicFontOfSize:16.0];
    [H24FontManager openSansBoldFontOfSize:16.0];
    [H24FontManager openSansBoldItalicFontOfSize:16.0];
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagJustifyLeftBarButton
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagJustifyCenterBarButton
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagJustifyFullBarButton
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagJustifyRightBarButton
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagBackgroundColorBarButton
...
- (UIBarButtonItem*)blockQuoteBarButton
{
	...
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagBlockQuoteBarButton
...
- (UIBarButtonItem*)boldBarButton
{
	...
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagBoldBarButton
													htmlProperty:@"bold"
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagH1BarButton
													htmlProperty:@"h1"
													   imageName:@"ZSSh1.png"
														  target:self
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagH2BarButton
													htmlProperty:@"h2"
													   imageName:@"ZSSh2.png"
														  target:self
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagH3BarButton
													htmlProperty:@"h3"
													   imageName:@"ZSSh3.png"
														  target:self
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagH4BarButton
													htmlProperty:@"h4"
													   imageName:@"ZSSh4.png"
														  target:self
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagH5BarButton
													htmlProperty:@"h5"
													   imageName:@"ZSSh5.png"
														  target:self
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagH6BarButton
													htmlProperty:@"h6"
													   imageName:@"ZSSh6.png"
														  target:self
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagHorizontalRuleBarButton
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagIndentBarButton
													htmlProperty:@"indent"
...
- (UIBarButtonItem*)insertImageBarButton
{
	...
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagInsertImageBarButton
													htmlProperty:@"image"
...
- (UIBarButtonItem*)inserLinkBarButton
{
	...
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagInsertLinkBarButton
													htmlProperty:@"link"
...
- (UIBarButtonItem*)italicBarButton
{
	...
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTagItalicBarButton
													htmlProperty:@"italic"
...
- (UIBarButtonItem*)orderedListBarButton
{
	...
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementOrderedListBarButton
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementOutdentBarButton
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementQuickLinkBarButton
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementRedoBarButton
												  htmlProperty:@"redo"
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementRemoveFormatBarButton
...
- (UIBarButtonItem*)showSourceBarButton
{
    ...
    ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementShowSourceBarButton
													htmlProperty:@"source"
...
- (UIBarButtonItem*)strikeThroughBarButton
{
	...
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementStrikeThroughBarButton
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementSubscriptBarButton
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementSuperscriptBarButton
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementTextColorBarButton
...
- (UIBarButtonItem*)underlineBarButton
{
	...
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementUnderlineBarButton
...
- (UIBarButtonItem*)unorderedListBarButton
{
	...
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementUnorderedListBarButton
...
{
	ZSSBarButtonItem *barButtonItem = [self barButtonItemWithTag:kH24EditorViewControllerElementUndoBarButton
													htmlProperty:@"undo"
...
- (void)buildTextViews
{
    if (!self.editorView) {
        ...
        self.editorView = [[H24EditorView alloc] initWithFrame:frame];
...
#pragma mark - H24EditorToolbarViewDelegate

- (void)editorToolbarView:(H24EditorToolbarView *)editorToolbarView
...
- (void)linkBarButtonTapped:(H24EditorToolbarButton*)button
{
							   ...
							   title:(NSString*)title
{
    ...
    self.alertView.tag = H24LinkAlertViewTag;
	...
	self.alertView.didDismissBlock = ^(UIAlertView *alertView, NSInteger buttonIndex) {
		...
		if (alertView.tag == H24LinkAlertViewTag) {
			if (buttonIndex == 1) {
...
#pragma mark - H24EditorViewDelegate

- (void)editorTextDidChange:(H24EditorView*)editorView
{
...
- (void)editorTitleDidChange:(H24EditorView *)editorView
{
...
- (void)editorViewDidFinishLoadingDOM:(H24EditorView*)editorView
{
...
- (void)editorView:(H24EditorView*)editorView
      fieldCreated:(H24EditorField*)field
{
    if (field == self.editorView.titleField) {
        ...
        [field setPlaceholderColor:[UIColor grayColor]];
...
- (void)editorView:(H24EditorView*)editorView
      fieldFocused:(H24EditorField*)field
{
    if (field == self.editorView.titleField) {
...
- (void)editorView:(H24EditorView*)editorView sourceFieldFocused:(UIView*)view
{
    [self.toolbarView enableToolbarItems:NO shouldShowSourceButton:YES];
...
- (BOOL)editorView:(H24EditorView*)editorView
...
- (void)editorView:(H24EditorView *)editorView videoPressInfoRequest:(NSString *)videoPressID
{
...
- (void)editorView:(H24EditorView *)editorView mediaRemoved:(NSString *)mediaID
{
...
- (void)editorView:(H24EditorView*)editorView stylesForCurrentSelection:(NSArray*)styles
{
