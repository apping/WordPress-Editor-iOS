...
@interface H24ImageMeta : NSObject
...
/**
 Creates a H24ImageMeta instance, populated with values from the passed JSON string.
 ...
 @return H24ImageMeta object
 */
+ (instancetype)imageMetaFromJSONString:(NSString *)str;

/**
 The H24ImageMeta instance as a JSON formatted object string. 
