...
@protocol H24EditorViewDelegate <UIWebViewDelegate>
@optional
 ...
 *	@param		editorView		The editor view.
 */
- (void)editorViewDidFinishLoading:(H24EditorView*)editorView;
...
@interface H24EditorView : UIView

/**
 *	@brief		The editor's delegate.
 */
@property (nonatomic, weak, readwrite) id<H24EditorViewDelegate> delegate;
...
@property (nonatomic, strong, readonly) H24EditorField* contentField;
@property (nonatomic, weak, readonly) H24EditorField* focusedField;
@property (nonatomic, strong, readonly) H24EditorField* titleField;
