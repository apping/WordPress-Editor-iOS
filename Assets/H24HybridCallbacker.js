...
function H24HybridCallbacker() {
};

// MARK: - Callbacks

H24HybridCallbacker.prototype.callback = function(callbackScheme, callbackPath) {
 ...
 */
H24HybridCallbacker.prototype.callbackThroughIFrame = function(url) {
